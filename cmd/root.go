...
import (
	...
	"github.com/luboszk/act/pkg/artifactcache"
	"github.com/luboszk/act/pkg/artifacts"
	"github.com/luboszk/act/pkg/common"
	"github.com/luboszk/act/pkg/container"
	"github.com/luboszk/act/pkg/gh"
	"github.com/luboszk/act/pkg/model"
	"github.com/luboszk/act/pkg/runner"
)
...
func defaultImageSurvey(actrc string) error {
	...
	confirmation := &survey.Select{
		...
		Help:    "If you want to know why act asks you that, please go to https://github.com/luboszk/act/issues/107",
		Default: "Medium",
